            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 mx-auto">
                        <p class="text">La réflexion qui va suivre n’a comme unique et autre but que d’offrir un paradigme à la pensée anarchiste. 
                            Elle part de la certitude qu’elle est la seule pensée en mesure de proposer à l’Humanité un avenir moins inique que celui imposé 
                            par le libéralisme triomphant de ce XXième siècle. Elle tient pour évidente que la seule manière d’y parvenir est de doter
                            l’anarchisme d’un entendement tel que Karl Marx l’a permis au communisme à travers son matérialisme historique. 
                            Pour ce faire et contre toute attente, respectivement à la mercantilisation  généralisée à laquelle nous assistons, ce n’est pas sur l’économie 
                            qu’elle s’appuie mais sur l’anthropologie. Sur l’anthropologie pour deux raisons. La première a trait aux travaux des anthropologues anarchistes 
                            eux-mêmes qui démontent une par une les évidences de notre modernité tel que la naturalité de l’État, de la loi du marché, du darwinisme sociale, etc.
                            La seconde est qu’elle s’en remet à l’immanence de l’anthropologie elle-même. 
                        </p>
                    </div>
                    ...
                    <div class="col-4 mx-auto">
                        <p class="text">Je ne pourrais dire si c’est sa fréquentation aussi systématique qu’assidue de sociétés hors temps, sinon hors d’âge qui permet ainsi à la discipline d’accéder à une réalité d’un autre ordre. En revanche, 
                        je tiens pour intuition que dans une certaine mesure cette porosité nous préserve d’une réelle théocratisation de la pensée, qui n’est autre à mes yeux que celle du dogmatisme de la pensée duale. Il est vrai que pour moi, 
                        Dieu et la dualité ne font qu’un. Éliminer l’un, c’est éliminer l’autre, le mieux étant de les retourner l’un contre l’autre pour les annihiler. 
                        Car autant s’éviter l’écueil du marxisme qui n’aboutit finalement qu’au sacre d’un ersatz de religion en élevant le matérialisme au statut de dogme.
                        D’ailleurs ce n’est pas tant pour le simple plaisir d’en finir avec des conceptions surannées et par trop limitantes que j’entreprends 
                        cette démarche mais bien pour permettre à la pensée humaine d’effectuer un saut quantique. Un saut nécessaire, imprescriptible même et ce afin de nous extirper des affres dans lesquelles nous nous abîmons et où finirons par nous perdre. 
                        </p>
                    </div>
                </div>
            </div>
