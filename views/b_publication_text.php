                                        ...
                                        <div class="card-body">
                                            <form enctype="multipart/form-data" action="<?= htmlspecialchars("b_index.php?page=publi_text"); ?>"  method="POST">
                                                ...
                                                <select name="id_publi" id="id_publi">
                                                    <?php foreach($publiSelect as $values): ?>
                                                ...
                                                <div class="d-flex align-items-center justify-content-center mt-4 mb-0">
                                                    <button  name="textPost" type="submit" class="btn btn-primary">Ajouter une Série</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
