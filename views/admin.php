            ...
            <button class="navbar-toggler align-center" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon "></span>
                ...
                <ul class="navbar-nav collapse navbar-collapse" id="navbarText">
                    ...
                    <li class="nav-item">
                        <a class="nav-link_menu col-lg-4 mx-auto" href="login.php">login</a> 
                    </li>
                    <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link_menu col-lg-4 mx-auto" href="deconnection.php">deconnection</a> 
                    </li>
                    <?php endif; ?>
                </ul>
        </nav>
            ...
            <button class="navbar-toggler align-center" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon "></span>
                ...
                <ul class="navbar-nav collapse navbar-collapse" id="navbarText">
                    ...
                    <li class="nav-item">
                        <a class="nav-link_menu col-lg-4 mx-auto" href="b_blog_administration.php">Blog</a> 
                    </li>
                    <li class="nav-item">
                        <a class="nav-link_menu col-lg-4 mx-auto" href="b_publication_articles.php">Publication articles</a> 
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link_menu col-lg-4 mx-auto" href="b_deconnection.php">deconnection</a> 
                    </li>
                    <?php endif; ?>
                </ul>
        </nav>
